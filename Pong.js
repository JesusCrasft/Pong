...
function gana() {
	if (puntosj1 > 19) {
		alert("Gano el jugador "+ju1);
		document.location.reload();
	}
	if (puntosj2 > 19) {
		alert("Gano el jugador "+ju2);
		document.location.reload();
	}
}

ju1 = prompt("Escriba el nombre del jugador 1");
ju2 = prompt("Escriba el nombre del jugador 2");
//clases
class Base {
	choque(obj) {
...
class jugadores {
	...
	dibujar() {
		ctx.fillStyle = 'black';
		ctx.font = "15px Arial";
		ctx.fillText("El jugador 1 es: " +ju1, 10, 290);
		ctx.fillStyle = 'black';
		ctx.font = "15px Arial";
		ctx.fillText("El jugador 2 es: " +ju2, 458, 290);
	}
}
//Objetos
var bola = new Bola();
